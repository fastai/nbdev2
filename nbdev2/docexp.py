...
# %% auto 0
__all__ = ['default_tpl', 'default_pp_cfg', 'preprocess_cell', 'preprocess', 'preprocess_rm_cell', 'doc_exporter', 'rm_digits',
           'InjectMeta', 'ShowMeta', 'StripAnsi', 'InsertWarning', 'RmEmptyCode', 'UpdateTags', 'HideInputLines',
           'FilterOutput', 'CleanFlags', 'CleanMagics', 'BashIdentify', 'CleanShowDoc', 'RmHeaderDash', 'RmExport',
           'default_pps', 'nb2md']
...
# %% ../nbs/01_docexp.ipynb 16
_re_digits = re.compile(r'^\d+[_|-]')
def rm_digits(nm):
    "Remove digits from start of a string"
    return _re_digits.sub('', nm)

# %% ../nbs/01_docexp.ipynb 19
